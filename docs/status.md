...
| Voice chat | Audible transmission confirmed on the combined local build before stop/restart and failure-cleanup hardening; the isolated PR branch, including that hardening, has automated verification only. See [verification details](analysis/voice-dual-response.md). |
